#!/usr/bin/env python3
"""Audit the bitset-compiled C3FD-v2.4 constructive witness."""
...
from audit_c3fd_v23_pauling_witness import (  # noqa: E402
    iter_jsonl,
    teacher_witness_counts,
)
...
def synthetic_gate() -> dict[str, bool]:
    ...
    return {
        "bitset_matches_recursive_synthetic": bitset_legal == recursive_legal,
        "split_false_positive_removed": lithium not in bitset_legal,
        "valid_oxide_path_retained": oxygen in bitset_legal,
    }
...
def main() -> None:
    ...
    parser.add_argument("--runtime-limit-sec", type=float, default=60.0)
    ...
    payload = {
        "schema": "h1a2_c3fd_v24_bitset_witness_audit_v1",
    ...
    stem = "C3FD_V24_BITSET_WITNESS_AUDIT"
    ...
    lines = [
        "# C³FD-v2.4 bitset-witness audit",
        "",
