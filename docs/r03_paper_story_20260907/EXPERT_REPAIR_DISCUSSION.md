...
### 0.9.1 初始模型实测与更新结果（2026-09-09 09:25北京时间）
...
G3已实际完成128个优化步，参数变化平方和0.0438716692，优化耗时843.7秒，训练与保存共854.1秒，检查点与冻结输入／输出表校验通过。两套原Plan和种子已逐字节登记到θ3，MAIN和TRAIN第三版生成均已启动。E3仍待第二轮TRAIN编辑提案的物理反馈与训练，当前完整G/E联合权重更新仍计2次。
