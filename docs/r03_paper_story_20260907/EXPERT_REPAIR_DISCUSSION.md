...
创建日期：2026-09-07。更新日期：2026-09-09。状态：按最新§0.15要求补完旧S1的E1及最终Edit/KEEP，并验证DLM三级恢复后重跑完整流程；旧G→F结果SUN27→26仅作历史诊断。本次仅TRAIN，12小时、4—6张A800，固定基座初始化，训练侧允许CHGNet指导；最新质量顺序为SUN＞严格Stable＞Meta Stable＞普通更稳定＞不稳定。轨迹按可复用数据集保留；GPU开始时间与绝对截止时间以正式运行回执为准。§0.11／§0.12为此前讨论与诊断，与最新计划冲突时以§0.15及未被覆盖的§0.14／§0.13为准。
