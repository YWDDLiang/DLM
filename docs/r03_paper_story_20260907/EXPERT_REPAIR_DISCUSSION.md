...
### 0.9.1 初始模型实测与首轮更新记录（2026-09-09 04:50北京时间）
...
初始MAIN编辑已完成256个请求：211个产生EDIT提案、12个选择KEEP、33个上游失败；接受头未提交任何提案，最终token全部与token-F相同。最终阶段的完整N/U评分仍待完成，不能用提案评分冒充实际输出。TRAIN编辑强制生成反事实提案用于比较，物理标注正在进行。
