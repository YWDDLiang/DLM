...
创建日期：2026-09-07。更新日期：2026-09-09。状态：本次仅TRAIN，预算12小时、4—6张A800；用户最新明确不从θ2继续、唯一目标为SUN、训练时间按实际需要灵活分配。§0.12记录SUN专项诊断与修正方向，§0.11同步更新执行设计，当前未启动新实验。此前原因诊断见§0.10，原三轮结果见§0.9.1。
