...
创建日期：2026-09-07。更新日期：2026-09-10（北京时间）。最新状态：用户要求完成当前S1后暂停1000运行，再研究Edit/KEEP的SUN和MSUN增益。G1与E1已实际更新，S1最终评价进行中；G2/E2/G3/E3不再提交。256请求的S0—S3与随后固定G/F的E试验均已完成，后者未通过采用条件，详见§0.17。1000运行继续使用干净TRAIN、B0及新E初始化、原18:01绝对截止，当前轮科学方法保持冻结。
