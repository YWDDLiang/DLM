...
2026-09-07（上海）更新。全链路与V3两轮独立审查、V2完整终点及冻结诊断已完成；H-P33正式两轮训练40064完整完成，评测40066运行中，连续来源、真实4/6卡及图回环门均已关闭。本文随新证据更新，**不表示用户授权的后续实验已经完成**。
...
40064新增2epoch已完整完成：4524更新、108544有效状态、T/G来源覆盖2/2，两轮验证结束。[训练终点](evidence/MIXED_TRAIN_FINAL_40064.json)。剩余：完成40066固定256 primary raw/refined与Q诊断，满足门槛则1000/1200。[评测清单](evidence/MIXED_EVAL_LAUNCH_MANIFEST.json)、[提交](evidence/MIXED_EVAL_SUBMISSION.json)。按用户最新授权，若V3两端缺乏可信改善，回到K4/K8或之前有效路径选择稳定性改动并实际应用；若有效，围绕统一科学问题的what/why/how收敛2–3项互补贡献。[故事契合边界](V3_STORY_FIT.md)与性能分开核对。不能在综述或单次负结果后提前结束，也不以没有事先SUN保证为由无限审计。
