...
negative methods are summarized once in [`FAILED_METHODS.md`](../v3_scientific_audit_20260906/historical/docs/FAILED_METHODS.md).
...
2. [`SCIENTIFIC_QUESTION_AND_CONTRIBUTIONS.md`](../v3_scientific_audit_20260906/historical/docs/paper/SCIENTIFIC_QUESTION_AND_CONTRIBUTIONS.md)
   — the central question and exactly three contributions.
3. [`METHOD_MAINLINE.md`](../v3_scientific_audit_20260906/historical/docs/paper/METHOD_MAINLINE.md) — equations, interfaces and
   training/inference details.
4. [`EXPERIMENT_MATRIX.md`](../v3_scientific_audit_20260906/historical/docs/paper/EXPERIMENT_MATRIX.md) — main results and matched
   ablations.
5. [`PAPER_STORY.md`](../v3_scientific_audit_20260906/historical/docs/paper/PAPER_STORY.md) — title, abstract, introduction and
   figure/table plan.
6. [`REPRODUCIBILITY.md`](../v3_scientific_audit_20260906/historical/docs/paper/REPRODUCIBILITY.md) — data, seeds, evidence profiles and run
   contracts.
...
[`PLAN1200_TAU800_FINAL_20260902.md`](../v3_scientific_audit_20260906/historical/docs/PLAN1200_TAU800_FINAL_20260902.md).
