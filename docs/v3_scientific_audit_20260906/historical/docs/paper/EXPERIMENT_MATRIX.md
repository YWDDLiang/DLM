...
- Planner: `results/remote_screens/C3FD_V25_REQUESTED1000_FINAL.json` and
  `docs/v3_scientific_audit_20260906/historical/docs/C3FD_LLAMA_DLM_SUN_CHECKLIST_V6.json`.
- Plan-conditioned DLM: `docs/v3_scientific_audit_20260906/historical/docs/C3FD_NATIVE_TEACHER_SFT_DATA_FINAL_20260831.json`
  and `docs/v3_scientific_audit_20260906/historical/docs/C3FD_NATIVE_TEACHER_SFT_FINAL_20260831.json`.
- Prospective system: `docs/v3_scientific_audit_20260906/historical/docs/36H_FINAL_REPORT_C3FD_G2_20260901.json`, remote
  run profile `prospective_headline`.
- Full epoch: `docs/v3_scientific_audit_20260906/historical/docs/G2_FULL_EPOCH_AB_FINAL_20260901.json`, profile
  `full_epoch_mechanism`.
- Plan1200 scale: `docs/v3_scientific_audit_20260906/historical/docs/PLAN1200_TAU800_FINAL_20260902.md`, profile
