...
- Artifact path：
  ...
  - 同目录 _SUCCESS
  - docs/v3_scientific_audit_20260906/historical/docs/SGTC_DLM_L7_CONTRACT_V1.md
...
- Artifact path：
  - results/remote_screens/sgtc_l7_official_final_20260829_v2/SGTC_L7_OFFICIAL_FINAL.json/.csv
  - docs/v3_scientific_audit_20260906/historical/docs/SGTC_DLM_V1_CONTRACT.md
...
- Artifact path：
  ...
  - engineering reports：docs/v3_scientific_audit_20260906/historical/docs/D3PO_37966_ENGINEERING_FAILURE.md、D3PO_38034_ENGINEERING_FAILURE.md、D3PO_38233_ENGINEERING_FAILURE.md
  - secondary_only：results/remote_screens/DLM_CAPABILITY_REGRESSION_36H.json
