...
- `docs/v3_scientific_audit_20260906/historical/docs/ASSET_TRANSFER_LEDGER.md:11-12` names the LLaDA base and B0 DLM
...
- It does not select one new 256-row cohort, recompute blocked identity/chemsys
  ...
  planning documents; `docs/v3_scientific_audit_20260906/historical/docs/DLM_RICH_PLANNER_DECISION_LOG_V2.md:68` also records
...
- `docs/v3_scientific_audit_20260906/historical/docs/RICH_DLM_EXECUTION_GAP_AUDIT_V1.md`
