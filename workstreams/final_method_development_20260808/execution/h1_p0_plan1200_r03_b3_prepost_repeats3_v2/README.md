...
This is the immutable V2 execution root.  It preserves the V1 scientific and
paired-seed contracts while adding the missing repository `scripts` package
initializer and a login-node import preflight.  The failed V1 root is sealed and
is neither modified nor reused.
