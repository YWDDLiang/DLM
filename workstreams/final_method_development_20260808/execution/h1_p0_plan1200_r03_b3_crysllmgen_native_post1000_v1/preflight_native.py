...
def main() -> None:
    ...
    if body_manifest_sha != config.get("body_source_manifest_sha256"):
        raise ValueError("body source manifest identity changed")
    ...
    if (
        ...
        raise ValueError("main V3 body submission evidence is incomplete")
    ...
    if (
        ...
        or sha256_file(cache_path) != cache.get("sha256")
    ...
    report = {
        "schema": "h1_plan1200_crysllmgen_native_preflight_v1",
        "status": "pass",
        ...
        "native_mp_cache": identity(cache_path),
