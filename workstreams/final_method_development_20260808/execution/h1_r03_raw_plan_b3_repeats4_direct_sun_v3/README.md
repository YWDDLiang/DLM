# R03 raw Plan × B3 repeated Direct/S.U.N. evaluation — V3

V2 failed closed before submitting Slurm work because its B3 adapter identity
was accidentally recorded as 62 hexadecimal characters. V3 changes only the
immutable execution identity and restores the exact 64-character adapter SHA
already used by the successful V4 source. Scientific inputs, model bytes,
cache, repeats, seeds, scorers, and statistics are unchanged.
