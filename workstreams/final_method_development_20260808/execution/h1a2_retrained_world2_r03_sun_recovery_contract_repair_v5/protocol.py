...
def validate_config(config: Mapping[str, Any]) -> None:
    ...
    if (
        config.get("schema") != "h1a2_retrained_world2_r03_sun_recovery_config_v1"
        or config.get("run_root")
        != "/public/home/jiaosz/ywliang/ai4s/diffsion_language_model_meets_diffusion/runs/20260812_h1a2_retrained_world2_r03_sun_recovery_contract_repair_v5"
