...
def validate_config(config: Mapping[str, Any]) -> None:
    ...
    if (
        config.get("schema")
        != "h1a2_retrained_world2_r03_postplanner_contract_repair_config_v2"
        or config.get("run_id")
        != "20260812_h1a2_retrained_world2_r03_postplanner_contract_repair_v7"
        or config.get("run_root")
        != "/public/home/jiaosz/ywliang/ai4s/diffsion_language_model_meets_diffusion/runs/20260812_h1a2_retrained_world2_r03_postplanner_contract_repair_v7"
        or continuation
        != {
            ...
            "failure_stage": "first_fresh_r03_before_model_load",
            "failure_signature": "KeyError: 'adapter_file'",
            "planner_sampling_rerun": False,
            "planner_outputs_byte_reused": True,
            "generation_outputs_reused": False,
            "slurm_job_ordinal_since_v5": 2,
            "remaining_official_slurm_jobs": 1,
        }
        ...
        != "postplanner_single_slurm_job_max4_a800_32cpu_v7"
