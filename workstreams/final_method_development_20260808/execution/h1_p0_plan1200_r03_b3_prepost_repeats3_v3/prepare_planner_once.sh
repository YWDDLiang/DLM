...
RUN_ID=20260811_h1_p0_plan1200_r03_b3_prepost_repeats3_execmode_repair_v3
EXECUTION_NAME=h1_p0_plan1200_r03_b3_prepost_repeats3_v3
RUN_ROOT="$PROJECT/runs/$RUN_ID"
TMP_ROOT="$PROJECT/runs/.$RUN_ID.preparing.$$"
SOURCE_STAGE="$TMP_ROOT/planner_source"

test -x "$SELF_DIR/prepare_planner_once.sh"
