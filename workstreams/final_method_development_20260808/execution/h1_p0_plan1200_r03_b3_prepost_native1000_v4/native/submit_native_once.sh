...
record = {
    "schema": "h1_plan1200_native1000_partial_submission_failure_v2",
...
from pathlib import Path
record = {
    "schema": "h1_plan1200_crysllmgen_native1000_submission_v2",
    "status": "complete",
