# P0 Plan1200 R03/B3 pre/post body evaluation — immutable V4

This package consumes the three frozen, independently sampled P0 cohorts from
`20260811_h1_p0_plan1200_r03_b3_prepost_native1000_cohort_contract_repair_v4`. Within each repeat the
...
The paired seed namespace remains the preregistered V1 namespace so the V4
