...
def assemble(args: argparse.Namespace) -> dict[str, Any]:
    ...
    report = {
        "schema": "h1_plan1200_r03_b3_prepost_repeats3_terminal_v4",
        "status": "complete",
        ...
        "artifacts": {
            ...
            "V3_input_import_contract": identity(
                run_root / "INPUT_IMPORT_CONTRACT.json"
            ),
            "V4_input_import_report": identity(
...
def main() -> None:
    ...
    try:
        ...
        failure = {
            "schema": "h1_plan1200_r03_b3_prepost_repeats3_terminal_failure_v4",
