...
def main() -> None:
    ...
    for repeat in range(3):
        ...
        if any(
            ...
            or '"charge_bucket"' not in str(row.get("body_prompt"))
            for row in rows
        ):
            raise ValueError(f"repeat {repeat} body prompt contract changed")
    ...
    if (
        ...
        or completion.get("source_manifest_sha256") != args.source_manifest_sha256
    ...
    report = {
        ...
        "sun": {
            ...
            "completed_cache": identity(cache_path),
