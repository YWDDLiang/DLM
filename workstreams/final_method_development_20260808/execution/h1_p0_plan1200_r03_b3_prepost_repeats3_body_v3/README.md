# P0 Plan1200 R03/B3 pre/post body evaluation — V3

This package consumes the three frozen, independently sampled P0 cohorts from
`20260811_h1_p0_plan1200_r03_b3_prepost_repeats3_execmode_repair_v3`.  Within each repeat the
...
The paired seed namespace remains the preregistered V1 namespace so the V3
