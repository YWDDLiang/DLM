...
RUN_ROOT="${PROJECT_ROOT}/runs/20260804_h1_crplan_r0_paired32_runtime_repair_v3"
SOURCE_ROOT="${RUN_ROOT}/source"
EXECUTION_DIR="${SOURCE_ROOT}/workstreams/plangraph_dlm_iclr_20260731/execution/h1_crplan_r0_paired32_runtime_repair_v3"
...
path = Path(
    ...
    "runs/20260804_h1_crplan_r0_paired32_runtime_repair_v3/status/"
    "cr0_submission_record.json"
)
payload = {
    "schema": "h1_crplan_r0_cr0_submission_record_v3",
    ...
    "runtime_repair": {
        ...
        "test_import_targets_immutable_v3_evaluator": True,
    },
