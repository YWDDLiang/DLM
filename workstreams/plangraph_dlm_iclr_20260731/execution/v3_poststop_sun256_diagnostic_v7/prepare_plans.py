...
# Reassert the frozen runtime at import time even if another module imported
# the shared project root first. Presence in sys.path is insufficient; order is
# the isolation boundary.
for location in (HERE, RUNTIME_ROOT):
    while str(location) in sys.path:
