...
SOURCE="$ROOT/workstreams/plangraph_dlm_iclr_20260731/execution/v3_poststop_sun256_diagnostic_v4"
RUN="$ROOT/runs/20260801_h1a2_v3_poststop_sun256_diagnostic_v4"
...
record = {
    "schema": "h1a2_v3_poststop_sun256_submission_v4",
    "status": "complete",
