...
path = Path(
    ...
    "runs/20260804_h1_crplan_r0_paired32_script_package_repair_v5/status/"
    "cr0_submission_record.json"
)
payload = {
    "schema": "h1_crplan_r0_cr0_submission_record_v5",
    ...
    "runtime_repair": {
        ...
        "test_import_targets_immutable_v5_evaluator": True,
        "cr0_unused_framework_probes_disabled": True,
        "direct_fixture_gcd_reduction_restored": True,
        "registered_pauling_fixture": "HSi",
        "v4_cr0_pass_job_id": "30348",
        "v4_cr0_terminal_report_sha256": (
            "dac9ffc3aa8fa699158236aea6056b144a724d47fdec3258564f2aea60c154e3"
        ),
        "v4_paired32_package_failure_job_id": "30353",
        "v4_paired32_package_failure_state": "FAILED",
        "v4_paired32_package_failure_exit_code": "1:0",
        "v4_paired32_package_failure_elapsed": "00:30:35",
        "scripts_package_marker_frozen": True,
    },
