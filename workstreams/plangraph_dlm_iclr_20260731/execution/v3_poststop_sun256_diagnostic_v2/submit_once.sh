...
SOURCE="$ROOT/workstreams/plangraph_dlm_iclr_20260731/execution/v3_poststop_sun256_diagnostic_v2"
RUN="$ROOT/runs/20260801_h1a2_v3_poststop_sun256_diagnostic_v2"
...
record = {
    "schema": "h1a2_v3_poststop_sun256_submission_v2",
    "status": "complete",
