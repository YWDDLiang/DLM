...
commit='c4b404a1c3ec4c46534e974c2d2a5144512bdf86'
pin='refs/codex/deployments/r03-c3fd-rich-main'
if s.run(['git','show-ref','--verify','--quiet',pin],cwd=repo).returncode:
 s.run(['git','update-ref',pin,'5b5193c315f1c8045e92f1f902f60b11e6fe89f3'],cwd=repo,check=True)
...
s.run(['git','update-ref',pin,commit],cwd=repo,check=True)
