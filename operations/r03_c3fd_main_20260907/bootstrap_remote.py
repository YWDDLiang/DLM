...
commit='a2e8f80a26be43ef3a46039154d8c02e2185a5a8'
s.run(['git','-c','http.lowSpeedLimit=1','-c','http.lowSpeedTime=20','fetch','https://github.com/YWDDLiang/DLM.git','codex/r03-c3fd-rich-main'],cwd=repo,check=True,timeout=35)
